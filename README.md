...
大学生找实习时，需要阅读大量岗位 JD，很难快速总结共同要求和岗位差异。
...
我没有只停留在调用大模型，而是围绕大学生“岗位信息多、关键词难总结”的问题设计了产品功能，并完成了多文档检索、岗位对比、专业匹配和无关问题拒答。

### 在线 Demo

https://yyylll53359-byte-kimi-ai-learning-assistant-job-rag-app-btqge0.streamlit.app/
